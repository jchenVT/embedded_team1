...
#define INIT_UART_DEBUG_Q 0x01
#define INIT_GPIO_DEBUG 0x02

#define UART_DEBUG_OPEN 0x10
#define UART_DEBUG_WRITE 0x11

#define UART_LIDAR_OPEN 0x1F
...
#define FAIL_UART_INIT 0xF0
#define FAIL_SPI_INIT 0xF1
#define FAIL_SPI_TIMER_INIT 0xF2
#define FAIL_SPI_TRANSACTION 0xF3
