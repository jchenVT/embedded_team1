...
#define UART_LIDAR_OPEN 0x30
#define UART_LIDAR_OPEN_DONE 0x31
#define UART_LIDAR_HEALTH 0x32
#define UART_LIDAR_STARTED 0x33
#define UART_LIDAR_POINT_IN 0x34

#define FAIL_UART_INIT 0x70
#define FAIL_SPI_INIT 0x71
#define FAIL_SPI_TIMER_INIT 0x72
#define FAIL_SPI_TRANSACTION 0x73
#define UART_LIDAR_HEALTH_FAIL 0x74
